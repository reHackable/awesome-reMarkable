...
- [matrix-remarkable-bot](https://github.com/abmantis/matrix-remarkable-bot) - Matrix chat bot to send PDFs and webpages (converted automatically to PDF) to the reMarkable Cloud.

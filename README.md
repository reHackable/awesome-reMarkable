...
- [re-Planner](https://github.com/PepikVaio/reMarkable/tree/main/reMarkable_paid/re-Planner) - reMarkable (calendar) template that can be fully customized or used in the basic version for free. Optimized for reMarkable.
